...
const ComponentName = () => {        
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg leading-relaxed text-gray-600">Discover a range of pricing and plans tailored to suit your business needs. Our transparent and flexible pricing model ensures that you only pay for what you need.</p>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="px-4 py-6 text-center">
                            <a href="#" title="" className="inline-flex items-center font-semibold text-[#F55B68] hover:text-pink-700">
                                Get Started
                        ...
                        <td className="px-4 py-6 text-center text-white bg-[#F55B68] rounded-b-xl">
    ...
    <div className="block mt-12 border-t border-b border-gray-200 divide-y divide-gray-200 lg:hidden">
        <div className="grid grid-cols-4 text-center divide-x divide-gray-200">
            <div className="px-2 py-2">
                <span className="text-sm font-medium text-[#F55B68]"> Free </span>
                <p className="mt-2 text-xl font-bold">$0</p>
                <span className="mt-1 text-sm font-normal text-gray-500"> Per month </span>
            </div>

            <div className="px-2 py-2">
                <span className="text-sm font-medium text-[#F55B68]"> Team </span>
                <p className="mt-2 text-xl font-bold">$99</p>
                <span className="mt-1 text-sm font-normal text-gray-500"> Per month </span>
            </div>

            <div className="px-2 py-2">
                <span className="text-sm font-medium text-[#F55B68]"> Popular </span>
                <p className="mt-2 text-xl font-bold">$150</p>
                <span className="mt-1 text-sm font-normal text-gray-500"> Per month </span>
            </div>

            <div className="px-2 py-2">
                <span className="text-sm font-medium text-[#F55B68]"> Enterprise </span>
