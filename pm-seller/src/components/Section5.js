...
const Section5 = () => {
  ...
  textShadow:"1.5px 1.5px 2px rgb(39, 39, 39)"}}>Story</a>
        ...
        <div>
          <img className={styles.str} src={story} />
        </div>
      </div>
...
<div>
  ...
  <div className={styles.section5Container4}>
    <div className={styles.section5SContainer4}>
      <img className={styles.st1} src={st1} />

      <p></p>
    </div>
  </div>
  <div className={styles.section5Container5}>
    <img className={styles.rec} src={rec} />

    <p> </p>
  </div>
  <div className={styles.section5Container7}>
    <img className={styles.bg1} src={bg} />
    <img className={styles.st3} src={st2} />
  ...
  <div className={styles.section5Container4}>
    <img className={styles.bg} src={bg} />
    <div className={styles.section5SContainer4}>
      <img className={styles.st2} src={st} />
  ...
  <div className={styles.promotion}>
    ...
    <img className={styles.st4} src={sc} />
    <img className={styles.st5} src={man} />
