...
const ComponentName = () => {        
    return (
        <section className="py-12 bg-gray-50 sm:py-16 lg:py-10">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                <p className="text-lg font-medium text-gray-600 font-pj">Pandrimarket has received acclaim from 2,157 individuals who have expressed their satisfaction.</p>
            ...
            <div className="relative mt-10 md:mt-24 md:order-2">
                <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                    <div className="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter" style={{background: "linear-gradient(225deg,#f55366 -0%,rgba(255, 155, 38, 0.56) 92.5%)"}}></div>
                </div>
                        ...
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“You made it so simple. Finding New Customers and Uploading products is so much faster and easier to work with than any other site. I just choose the page, make the change.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Faishon House(owner)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“Simply the best. Better than all the rest. I’d recommend this product to everyone.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Parag Faishon(owner)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I cannot believe that I have got a brand new landing page after onboarding Pandrimarket. It was super easy to edit and publish.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Muklava Store(owner)</p>
                                </div>
                            </div>
                        </div>
                    </div>
