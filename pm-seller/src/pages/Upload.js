        ...
        <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4">
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <img className="object-cover w-full h-[200px] transition-all duration-300 group-hover:scale-125" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/19/e2/43/9b/the-shops-at-south-town.jpg?w=1200&h=-1&s=1" alt="" />
                </div>
